...
namespace BeautyLand.Persistence.Migrations
{
    ...
    [Migration("20240824130506_CreatePaymentEntity")]
            ...
            modelBuilder.Entity("BeautyLand.Domain.Baskets.Basket", b =>
                {
                    ...
                    b.Property<DateTime?>("CreateDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 8, 24, 15, 5, 5, 509, DateTimeKind.Local).AddTicks(57));
            ...
            modelBuilder.Entity("BeautyLand.Domain.Baskets.BasketItem", b =>
                {
                    ...
                    b.Property<DateTime?>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 24, 15, 5, 5, 522, DateTimeKind.Local).AddTicks(280));
            ...
            modelBuilder.Entity("BeautyLand.Domain.Catalogs.Brands.Brand", b =>
                {
                    ...
                    b.Property<DateTime?>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 24, 15, 5, 5, 522, DateTimeKind.Local).AddTicks(3436));
            ...
            modelBuilder.Entity("BeautyLand.Domain.Catalogs.Features.Feature", b =>
                {
                    ...
                    b.Property<DateTime?>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 24, 15, 5, 5, 522, DateTimeKind.Local).AddTicks(5377));
            ...
            modelBuilder.Entity("BeautyLand.Domain.Catalogs.Images.Image", b =>
                {
                    ...
                    b.Property<DateTime?>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 24, 15, 5, 5, 522, DateTimeKind.Local).AddTicks(7199));
            ...
            modelBuilder.Entity("BeautyLand.Domain.Catalogs.Items.Item", b =>
                {
                    ...
                    b.Property<DateTime?>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 24, 15, 5, 5, 522, DateTimeKind.Local).AddTicks(9904));
            ...
            modelBuilder.Entity("BeautyLand.Domain.Catalogs.Type.Type", b =>
                {
                    ...
                    b.Property<DateTime?>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 24, 15, 5, 5, 523, DateTimeKind.Local).AddTicks(3050));
            ...
            modelBuilder.Entity("BeautyLand.Domain.Order.Order", b =>
                {
                    ...
                    b.Property<DateTime?>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 24, 15, 5, 5, 523, DateTimeKind.Local).AddTicks(5772));
            ...
            modelBuilder.Entity("BeautyLand.Domain.Order.OrderItem", b =>
                {
                    ...
                    b.Property<DateTime?>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 24, 15, 5, 5, 523, DateTimeKind.Local).AddTicks(9628));
            ...
            modelBuilder.Entity("BeautyLand.Domain.Users.UserAddress", b =>
                {
                    ...
                    b.Property<DateTime?>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 24, 15, 5, 5, 524, DateTimeKind.Local).AddTicks(2668));
