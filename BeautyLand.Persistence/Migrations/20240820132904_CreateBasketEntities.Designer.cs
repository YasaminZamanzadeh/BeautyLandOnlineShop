...
namespace BeautyLand.Persistence.Migrations
{
    ...
    [Migration("20240820132904_CreateBasketEntities")]
    partial class CreateBasketEntities
    {
            ...
            modelBuilder.Entity("BeautyLand.Domain.Baskets.Basket", b =>
                {
                    ...
                    b.Property<DateTime?>("CreateDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 8, 20, 15, 29, 3, 999, DateTimeKind.Local).AddTicks(5639));
            ...
            modelBuilder.Entity("BeautyLand.Domain.Baskets.BasketItem", b =>
                {
                    ...
                    b.Property<DateTime?>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 20, 15, 29, 4, 19, DateTimeKind.Local).AddTicks(477));
            ...
            modelBuilder.Entity("BeautyLand.Domain.Catalogs.Brands.Brand", b =>
                {
                    ...
                    b.Property<DateTime?>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 20, 15, 29, 4, 19, DateTimeKind.Local).AddTicks(6801));
            ...
            modelBuilder.Entity("BeautyLand.Domain.Catalogs.Features.Feature", b =>
                {
                    ...
                    b.Property<DateTime?>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 20, 15, 29, 4, 19, DateTimeKind.Local).AddTicks(9383));
            ...
            modelBuilder.Entity("BeautyLand.Domain.Catalogs.Images.Image", b =>
                {
                    ...
                    b.Property<DateTime?>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 20, 15, 29, 4, 20, DateTimeKind.Local).AddTicks(2285));
            ...
            modelBuilder.Entity("BeautyLand.Domain.Catalogs.Items.Item", b =>
                {
                    ...
                    b.Property<DateTime?>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 20, 15, 29, 4, 20, DateTimeKind.Local).AddTicks(6960));
            ...
            modelBuilder.Entity("BeautyLand.Domain.Catalogs.Type.Type", b =>
                {
                    ...
                    b.Property<DateTime?>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 20, 15, 29, 4, 21, DateTimeKind.Local).AddTicks(2785));
